...
class EmployeControleur extends UserController
{
    protected ReservationGateway $reservationGateway;
    public function __construct()
    {
        // On laisse le parent initialiser la connexion et l'API
        parent::__construct(); 
    }

    // On surcharge la gestion des actions pour ajouter les droits Employé
    protected function gererActions()
    {
        ...
        switch ($action) {
            ...
            default:
                // Si l'action n'est pas spécifique à l'employé, on demande au parent (UserController)
                parent::gererActions(); 
                break;
        }
    }
